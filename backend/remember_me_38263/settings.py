"""
Django settings for remember_me_38263 project.
...
ROOT_URLCONF = 'remember_me_38263.urls'
...
WSGI_APPLICATION = 'remember_me_38263.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "remember_me_38263 API",
    "DESCRIPTION": "API documentation for remember_me_38263 App",
    "VERSION": "v1",
}
